...
**Note: This project is still under active development. Several features are incomplete or planned for future updates, including camera integration for gesture recognition on the Raspberry Pi version and speech-to-text support for both desktop and Raspberry Pi builds. The health assessments generated by this system are experimental and meant only for testing and educational purposes. They should not be used as a substitute for professional medical advice. Always consult a qualified healthcare provider for real medical concerns..**  
